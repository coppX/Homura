...
namespace Homura
{
    ...
    private:
        ...
        {
            VulkanShader vertShader(std::make_shared<VulkanDevice>(rhi->getDevice()->getPhysicalHandle()));
            VulkanShader fragShader(std::make_shared<VulkanDevice>(rhi->getDevice()->getPhysicalHandle()));
